...
const paymentModel = {
    ...
    async verify(reference) {
        ...
        return data_source.getRepo('Payment').transaction(async (manager) => {
            ...
            await (0, authModel.creditOwnerWallet)(manager, booking.vehicle.ownerId, Number(payment.amount), env.env.platformCommissionRate, reference, `Rental payment for booking ${booking.id}`);
