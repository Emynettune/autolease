...
const RefreshToken = defineEntity({
    name: 'RefreshToken',
...
const BlacklistedToken = defineEntity({
...
const DeviceSession = defineEntity({
    name: 'DeviceSession',
...
const WalletTransaction = defineEntity({
...
const VehicleImage = defineEntity({
    name: 'VehicleImage',
...
const BankAccount = defineEntity({
    name: 'BankAccount',
