...
function requireEnv(key, fallback, options = {}) {
    ...
    if (!value || (options.rejectDevFallback && exports.env?.nodeEnv === 'production' && value === fallback))
...
if (exports.env.nodeEnv === 'production') {
    ...
    if (exports.env.jwt.accessSecret === 'dev_access_secret' || exports.env.jwt.refreshSecret === 'dev_refresh_secret') {
